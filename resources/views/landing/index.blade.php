...
<header class="masthead text-center text-white">
    <div class="masthead-content">
        <div class="container px-5">
            ...
            <h2 class="masthead-subheading mb-0">SMP Negeri 02 Kepahiang</h2>
...
<section>
    <div class="container px-5">
        <div class="row gx-5 align-items-center">
            <div class="col-lg-6">
                <div class="p-5"><img class="img-fluid" src="{{ asset('storage/images/logo.jpeg') }}" />
                </div>
            </div>
            <div class="col-lg-6">
                <div class="p-5">
                    <h2 class="display-4">Tentang Kami</h2>
                    <p>Klik di bawah ini untuk menuju laman Tentang Perpustakaan SMP Negeri 02 Kepahiang.</p>
